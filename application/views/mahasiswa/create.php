<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <form action="<?= base_url(); ?>mahasiswa/create" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
        <div class="row g-3">
            <div class="col-sm-6">
                <label for="no_induk" class="form-label">No Induk</label>
                <input name="no_induk" type="number" class="form-control mb-2 <?= (form_error('no_induk')) ? 'is-invalid' : ''; ?>" id="no_induk" placeholder="" value="<?= set_value('no_induk'); ?>" required>
                <span class="text-danger"><?= form_error('no_induk'); ?></span>
            </div>

            <div class="col-sm-6">
                <label for="nama" class="form-label">Nama</label>
                <input name="nama" type="text" class="form-control mb-2 <?= (form_error('nama')) ? 'is-invalid' : ''; ?>" id="nama" placeholder="" value="<?= set_value('nama'); ?>" required>
